...
public class TC_Document_Documenttype_created extends Baseclass  {
...
Readconfig config= new Readconfig();
	...
	public String editdocumenttype=config.geteditdocumenttype();
	 ...
	 @Test
	    ...
	    Thread.sleep(2000);
	   // docty.clickonnewdocumenttype();
	    docty.clickondocumenteditbutton();
	    Thread.sleep(2000);
	    //docty.setdocumenttype(documenttype);
	    docty.seteditdocumenttype(editdocumenttype);
	    Thread.sleep(2000);
	    //docty.clickondocumenttypesave();
	    docty.clickoneditdocumenttypesave();
