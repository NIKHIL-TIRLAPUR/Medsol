...
public class TC_Frontcms_testimonials_delete  extends Baseclass 
{
	...
	Thread.sleep(2000);
	testimonals.setnamesearchbox(edittotitle);
	testimonals.clickondeletebutton();
	testimonals.clickonyesdeletebutton();
