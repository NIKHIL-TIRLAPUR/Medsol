...
public class TC_Inventories_item_modified extends Baseclass {
	...
	Thread.sleep(2000);
	item.seteditItemName(edititemName);
	item.seteditItemCategory(itemCategoryNames);
	item.seteditItemUnit(edititemUnit);
	item.seteditdescription(editdescription);
	item.clickoneditItemSave();
