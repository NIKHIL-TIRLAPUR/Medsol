...
public class TC_Diagnosis_Diagnosiscategory_created extends Baseclass {
	...
	Thread.sleep(2000);	
	dcategory.clickonnewDiagnosiscategory();
	Thread.sleep(2000);	
	dcategory.setDiagnosiscategoryname(diagnosiscategory);
	dcategory.setDiagnosiscategorydescription(description);
	dcategory.clickonDiagnosiscategorysavebutton();
