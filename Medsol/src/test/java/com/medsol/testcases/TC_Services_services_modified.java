...
public class TC_Services_services_modified extends Baseclass {
	...
	Thread.sleep(2000);
	service.clickonsearchboxfordeleteoredit(servicename);
	service.clickoneditbutton();
	Thread.sleep(2000);
	service.seteditname(editservicename);
	service.seteditquantity(editquantity);
	service.seteditrate(editrate);
	service.seteditdescription(editdescription);
