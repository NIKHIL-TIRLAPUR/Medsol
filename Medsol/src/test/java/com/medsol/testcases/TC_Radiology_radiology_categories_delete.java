...
public class TC_Radiology_radiology_categories_delete extends Baseclass  {
...
Readconfig config= new Readconfig();
	...
	Thread.sleep(2000);
	radio.setnameinthesearchbox(editradiologyCategoryName);
	Thread.sleep(2000);
	radio.clickondeletebutton();
	Thread.sleep(2000);
	radio.clickonyesdeletebutton();
	Thread.sleep(2000);
