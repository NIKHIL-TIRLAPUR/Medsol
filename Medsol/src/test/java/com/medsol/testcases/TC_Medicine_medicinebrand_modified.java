...
public class TC_Medicine_medicinebrand_modified extends Baseclass{
	...
	Thread.sleep(2000);
	medb.clickoneditbutton();
	medb.seteditbrandName(editstockSupplierName);
	String number=randomnum();
	String phonenumber="99005"+ number;
	medb.seteditbrandPhoneNumber(phonenumber);
	String email=randomstring()+"@gmail.com";
	medb.seteditbrandEmail(email);
