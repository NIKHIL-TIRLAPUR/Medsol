...
public class Bedmanagement_bedspage extends Baseclass {

WebDriver ldriver;
	
	public Bedmanagement_bedspage(WebDriver rdriver)
	{
		ldriver=rdriver;
	...
	@FindBy(xpath="//div[@class='dropdown']//button[@id='dropdownMenuButton1']")
